...
import com.carlospatinos.salesforceconnector.exceltion.CannotSubscribe;
...
public class CometdConnector {
    ...
    private static final Logger log = LoggerFactory.getLogger(CometdConnector.class);
    ...
    public CometdConnector(BayeuxParameters parameters) {
    ...
    public CometdConnector addListener(String channel, ClientSessionChannel.MessageListener messageListener) {
